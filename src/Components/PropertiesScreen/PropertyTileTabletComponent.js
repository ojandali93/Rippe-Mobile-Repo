...
const PropertyTileTabletComponent = (props) => {
      ...
      <View style={styles.investmentComponent}>
        <View style={styles.column}> 
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>${convertToDollarAmount(monthlyRevenueAmount)}</Text>
          </View>
          ...
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>${convertToDollarAmount(monthlyExpenses)}</Text>
          </View>
          <Modal
          ...
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>${convertToDollarAmount(mortgageAmount)}</Text>
          </View>
          <Modal
          ...
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>${convertToDollarAmount(cashFlow)}</Text>
          </View>
          ...
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>${convertToDollarAmount(NetOperatingIncome)}</Text>
          </View>
          <Modal
            visible={accessNOI}
            animationType="slide"
          ...
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>{capRate}%</Text>
          </View>
          <Modal
          ...
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>{cocReturn}%</Text>
          </View>
          ...
          <View style={styles.metric}>
            ...
            <Text style={styles.tabletMetricText}>{returnOnInvestment}%</Text>
          </View>
  ...
  return(
    <View key={property.zpid} style={styles.tabletProperty}>
      <TouchableOpacity onPress={() => {addPropertyView(property)}}> 
        ...
        {
          metricLoading ? displayLoading() : displayMetrics()
        }
...
export default PropertyTileTabletComponent